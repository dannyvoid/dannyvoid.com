...
!(function(t) {
    ...
    function(t, e, n) {
            ...
            i && n.dispatch((0, y.rawDataImported)(i)),
                ...
                (n.dispatch(
                    ...
                    ((function(t) {
                        ...
                        })(n), -1 === (e = document.documentElement).className.indexOf(R) &&
        ...
        function _t(t) {
            ...
            e.dispatch(
                    (0, y.instanceAdded)(
                        (0, a.default)({ instanceId: l, elementId: h, origin: _, refType: g },
                            r
                        )
                    )
                ),
        ...
        t.exports = function(t, e) {
            ...
            if ((n = h ? r : E ? r[v] || u(v, {}) : (r[v] || {}).prototype))
                for (f in e) {
                    if (
                        ((d = e[f]),
                            (l = t.noTargetGet ? (p = i(n, f)) && p.value : n[f]), !s(h ? f : v + (E ? "." : "#") + f, t.forced) && void 0 !== l)
                    ) {
        ...
        e.ixInstances = function() {
            ...
            switch (e.type) {
                ...
                case l:
                    ...
                    if (!t[W]) return t;
                    for (
                        var H = {}, z = Object.keys(t), Y = z.length, K = 0; K < Y; K++
                    ) {
                        var Q = z[K];
                        Q !== W && (H[Q] = t[Q]);
                    }
                ...
                (0, o.default)(r, P, {
                    ...
                    handler: function(t) {
                        ...
                        return (
                            ...
                            ((w = f ? 1 - w : w),
                                e.dispatch((0, g.parameterChanged)(A, w))), { elementHovered: S, clientX: v, clientY: _, pageX: m, pageY: T }
                        );
                    },
                }),
                (0, o.default)(r, W, {
                ...
                (0, o.default)(r, G, {
                    ...
                    handler: function(t) {
                        ...
                        if (d === h.EventBasedOn.VIEWPORT) {
                            ...
                            return (
                                A !== o.scrollPercent &&
                                n.dispatch((0, g.parameterChanged)(v, A)), { scrollPercent: A }
                            );
                        }
                        var S = K(i, v),
                        ...
                        return (
                            P !== o.scrollPercent &&
                            n.dispatch((0, g.parameterChanged)(S, P)), { scrollPercent: P }
                        );
                    },
                }),
                (0, o.default)(r, j, Et),
        ...
        function s(t, e, n, r) {
            ...
            (E.build = function() {
                return (
                    ...
                    s.lightbox.on("keydown", w).on("focusin", b),
...
Webflow.require("ix2").init({
    events: {
        "e-5": {
            ...
            target: {
                id: "5fa867642f679e045921adff|26275843-120f-d48c-229f-3fc0a75a9e55",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [{
